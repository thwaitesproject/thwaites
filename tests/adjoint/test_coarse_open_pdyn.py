...
def test_coarse_open_pdyn_mu():
    ...
    if DUMP:
        with DumbCheckpoint(dump_file, mode=FILE_UPDATE) as chk:
            ...
            T_restorefield = Function(K, name="Trestore field")
            S_restorefield = Function(K, name="Srestore field")
    #        chk.load(T_restorefield, name="temp restore")
    #        chk.load(S_restorefield, name="sal restore")
...
#             +"_structured_dy500_dz2_no_limiter_nosponge_open_qadvbc_pdyn_consTS_adjoint_objTSprofweightscale_opt_cb_noreg_checkunits/"
    ...
    #g_opt = minimize(rf, options={"disp": True, "maxiter": 1})
...
#test_coarse_open_pdyn_mu()

def test_coarse_open_pdyn_sal():
...
#             +"_structured_dy500_dz2_no_limiter_nosponge_open_qadvbc_pdyn_consTS_adjoint_objTSprofweightscale_opt_cb_noreg_checkunits/"
    ...
    print("sal TT ten steps")
    assert np.allclose(tt, [2.0, 2.0, 2.0], rtol=5e-2)

#test_coarse_open_pdyn_sal()

def test_coarse_open_pdyn_temp():
...
#             +"_structured_dy500_dz2_no_limiter_nosponge_open_qadvbc_pdyn_consTS_adjoint_objTSprofweightscale_opt_cb_noreg_checkunits/"
    ...
    print("temp TT ten steps")
    assert np.allclose(tt, [2.0, 2.0, 2.0], rtol=5e-2)

#test_coarse_open_pdyn_temp()


def test_coarse_open_pdyn_Tbc():
...
#             +"_structured_dy500_dz2_no_limiter_nosponge_open_qadvbc_pdyn_consTS_adjoint_objTSprofweightscale_opt_cb_noreg_checkunits/"
    ...
    print("Tbc TT ten steps")
    assert np.allclose(tt, [2.0, 2.0, 2.0], rtol=5e-2)

#test_coarse_open_pdyn_Tbc()

def test_coarse_open_pdyn_Sbc():
