...
folder = "/data/thwaites/28.11.18.ice_shelf_cavity_circulation_3_eq_param4/"
...
#q_ice_top_boundary = Q_ice.at(shelf_boundary_points)
#q_mixed_top_boundary = Q_mixed.at(shelf_boundary_points)
#q_latent_top_boundary = Q_latent.at(shelf_boundary_points)
#q_salt_top_boundary = Q_s.at(shelf_boundary_points)
#melt_top_boundary = melt.at(shelf_boundary_points)
#freezing_temp_top_boundary = Tb.at(shelf_boundary_points)
#full_pressure_top_boundary = Tb.at(shelf_boundary_points)




#top_boundary_dict = ['Qice_dt_0': q_ice_top_boundary,'Qmixed_dt_0': q_mixed_top_boundary},\
#    'Qlat_dt_0': q_latent_top_boundary,'Qsalt_dt_0': q_salt_top_boundary,'Melt_dt_0':melt_top_boundary \
#    'Tb_dt_0': freezing_temp_top_boundary, 'P_dt_0': full_pressure_top_boundary]
...
while t < T - 0.5*dt:
    ...
    if step % output_step == 0:
        ...
        df['Melt_t_' + t_str] = melt.at(shelf_boundary_points)
