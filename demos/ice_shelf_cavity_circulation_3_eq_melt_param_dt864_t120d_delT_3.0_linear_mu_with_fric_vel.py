...
mesh = Mesh("/data2/wis15/meshes/mesh.msh") # for piggt
#mesh = Mesh("/data/thwaites/meshes/mesh/ice_shelf_cavity_mesh.msh")  # for skrs-g36-006
...
mu = 3.96E-4*x + 0.02 # linearly vary viscosity over domain.
...
folder = "/data2/wis15/outputs/3.12.18.ice_shelf_cavity_circulation_3_eq_param_dt_864_t120_delT_3.0_linear_mu_w.fric_vel/" # for piggt
...
q_ice, q_mixed, q_mixed_real, q_latent, q_s, wb, t_b, pfull = MeltRateParam(sal, temp, p_,h_ice,z,dz).three_eq_param_meltrate_friction_vel(u)
