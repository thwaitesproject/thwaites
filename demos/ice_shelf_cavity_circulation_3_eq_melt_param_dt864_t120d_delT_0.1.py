...
temp_init = Constant(-2.62)   # Tinit =Tres = -1.63 deg C from ben's thesis page 54
...
folder = "/data2/wis15/outputs/3.12.18.ice_shelf_cavity_circulation_3_eq_param_dt_864_t120_delT_0.1/"
...
Trestore = -2.62   # delT = Trestore - Tf, where Tf = -2.63  # degC  n.b delta T = 0.1degC  (ben's thesis page
