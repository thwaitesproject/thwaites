...
folder = "/data/thwaites/18.12.18.iSWING_3_eq_param_dt_864_t120_delT_minus2.0_change_p_split/"
...
q_ice, q_mixed, q_mixed_real, q_latent, q_s, wb,t_b,s_b, pfull = MeltRateParam(sal, temp, p,cavity_depth,z,dz).three_eq_param_meltrate_friction_vel(u)
...
df['Sb_t_0.0']= Sb.at(shelf_boundary_points)
...
while t < T - 0.5*dt:
    ...
    if step % output_step == 0:
        ...
        df['Sb_t_'+t_str]= Sb.at(shelf_boundary_points)
