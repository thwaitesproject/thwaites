...
folder = "/data/msci_testing/31.10.19.3_eq_param_dt_100_t120_delT_3.0/"  # output folder.
...
temp_fields = {'diffusivity': kappa_temp, 'velocity': u}
sal_fields = {'diffusivity': kappa_sal, 'velocity': u}
...
q_ice, q_mixed, q_mixed_real, q_latent, q_s, wb, t_b, s_b, pfull = MeltRateParam(sal, temp, p_,cavity_depth,z,dz).three_eq_param_meltrate()
...
sal_bcs ={2: {'q': Srestore}, 1: {'flux': -Q_s}}
