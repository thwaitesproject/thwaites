...
folder = "/data/thwaites/18.12.18.iSWING_3_eq_param_dt_864_t120_delT_0.1_change_p_split_no_fric_vel/"
...
q_ice, q_mixed, q_mixed_real, q_latent, q_s, wb, t_b, s_b, pfull = MeltRateParam(sal, temp, p,cavity_depth,z,dz).three_eq_param_meltrate()
