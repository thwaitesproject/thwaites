...
temp_init = Constant(0.37)#+slot_cyl   # Tinit =Tres deg C from ben's thesis page 54
...
folder = "./06.11.18.two_eq_ice_vert_diff_test6/"
...
temp_bcs = {}#4: {'flux': Q_mixed}}   # heat flux = rho0*melt*Lf
