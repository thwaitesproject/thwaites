...
folder = "/data/thwaites/22.11.18.ice_shelf_cavity_circulation_iterative1/"
...
pressure_nullspace = VectorSpaceBasis(constant=True) # dont use in an open box
...
up_timestepper = PressureProjectionTimeIntegrator([mom_eq, cty_eq], m, up_fields, up_coupling, dt, up_bcs,
...
while t < T - 0.5*dt:
    ...
    limiter.apply(u_comp)
    
    v_comp.interpolate(u_[1])  # befror eit was u_comp u0
