...
folder = "./16.11.18.rayleigh_taylor_inst_open_iterative4/"
...
up_bcs = {1: no_normal_flow, 2: no_normal_flow, 3: no_normal_no_slip_flow, 4: {}}# no_normal_no_slip_flow}
