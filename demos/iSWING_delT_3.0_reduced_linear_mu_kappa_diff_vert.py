...
kappa_temp_hor = 3.96E-4*x + 0.02
kappa_sal_hor = 3.96E-4*x + 0.02
mu_hor = 3.96E-4*x + 0.02
...
#gradient_line = (mu_min-mu_min_lhs)/linear_start

# tanh profile
#rhs_mu = 0.5*(mu_max+mu_min) + 0.5*(mu_max-mu_min)*tanh((x-4250.0)/150.0)
#rhs_kappa_temp = 0.5*(mu_max+mu_min) + 0.5*(mu_max-mu_min)*tanh((x-4250.0)/150.0)
#kappa_sal = 0.5*(mu_max+mu_min) + 0.5*(mu_max-mu_min)*tanh((x-4250.0)/150.0)

# tanh profile on rhs for x> 3500. x < 3500 linear to mu = 0.02 at GL
#mu_hor = conditional(x>3500,
    #             0.5*(mu_max+mu_min) + 0.5*(mu_max-mu_min)*tanh((x-4250.0)/150.0),
    #             gradient_line*x + mu_min_lhs)
#kappa_temp_hor = conditional(x>3500,
   #              0.5*(mu_max+mu_min) + 0.5*(mu_max-mu_min)*tanh((x-4250.0)/150.0),
   #              gradient_line*x + mu_min_lhs)
#kappa_sal_hor = conditional(x>3500,
 #                0.5*(mu_max+mu_min) + 0.5*(mu_max-mu_min)*tanh((x-4250.0)/150.0),
  #               gradient_line*x + mu_min_lhs)


#mu_min_vert=2.812E-3 #
#mu_min_lhs_vert = 4.0E-6

#gradient_line_vert = (mu_min_vert-mu_min_lhs_vert)/linear_start

#mu_vert = conditional(x>3500,
 #                0.5*(mu_max+mu_min_vert) + 0.5*(mu_max-mu_min_vert)*tanh((x-4250.0)/150.0),
  #               gradient_line_vert*x + mu_min_lhs_vert)
#kappa_temp_vert = conditional(x>3500,
 #                0.5*(mu_max+mu_min_vert) + 0.5*(mu_max-mu_min_vert)*tanh((x-4250.0)/150.0),
  #               gradient_line_vert*x + mu_min_lhs_vert)
#kappa_sal_vert = conditional(x>3500,
#                 0.5*(mu_max+mu_min_vert) + 0.5*(mu_max-mu_min_vert)*tanh((x-4250.0)/150.0),
#                 gradient_line_vert*x + mu_min_lhs_vert)


vert_factor = 100 - 0.0198*x
mu_vert = mu_hor/vert_factor
kappa_temp_vert = kappa_temp_hor/vert_factor
kappa_sal_vert = kappa_sal_hor/vert_factor
...
folder = "/data/thwaites/12.12.18.iSWING_3_eq_param_dt_864_t120_delT_3.0_reduced_mu_kappa_linear_output10dt/"
