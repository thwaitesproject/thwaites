...
d=1
mesh = Mesh("/data/thwaites/meshes/mesh/RT_rect_mesh_refined_0.001.msh") #RectangleMesh(50, 400,0.5,4) #Mesh("ice_shelf_mesh3.msh")#
...
folder = "/data/thwaites/2.12.18.rayleigh_taylor_inst_open_iterative_unstruct_refined1/"
...
up_bcs = {1: {}, 2: no_normal_flow, 3: no_normal_no_slip_flow, 4: no_normal_flow}# no_normal_no_slip_flow}
...
while t < T - 0.5*dt:
    ...
    v_comp.interpolate(u[1])   # befror eit was u_comp u0
