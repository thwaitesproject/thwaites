...
# Set up folder
folder = "/data2/wis15/phd_outputs/ice_shelf_cavity_mitgcm_comparison_adjoint/"+str(args.date)+"_3_eq_param_ufric_dt"+str(dt)+\
         ...
         +"_structured_dy50_dz1_closed_adjoint_from50days/"
