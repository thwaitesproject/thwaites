...
# Define a dump file
dump_file = "/data/2d_kimura13_icestep/05.05.20_3_eq_param_ufricJ10_dt200.0_dtOutput86400.0_T8640000.0_ip50.0_Kh100.0_Kv0.01_2d_kimura13_closed_iterative/dump.h5"
...
folder = "/data/2d_kimura13_icestep/"+str(args.date)+"_3_eq_param_ufricJ10_dt"+str(dt)+\
         ...
         +"_2d_kimura13_closed_iterative_from29daysKv0.01/"
