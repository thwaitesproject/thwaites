...
f = Function(Vc).interpolate(as_vector([x, y, conditional(x + dy < shelf_length, ocean_thickness_extruded.view_3d*z/(P0dg_cells.view_3d*dz) - -bathymetry.view_3d, 
                                                z - - bathymetry.view_3d)]))
...
folder = "/data/3d_isomip_plus/extruded_meshes/"+str(args.date)+"_3d_isomip+_dt"+str(dt)+\
         ...
         "_dx"+str(round(1e-3*dy))+"km_dz"+str(dz)+"_closed_coriolis_tracerlims_ip3_alignicefront_backeul/"
