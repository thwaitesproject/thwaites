...
# create mesh
mesh = Mesh("./10km_flume_crevasse_3d.msh")
...
# Set up folder
folder = "/data/3d_crevasse/"+str(args.date)+"_10kmflume_3_eq_param_ufricHJ99_dt"+str(dt)+\
         "_dtOutput"+str(output_dt)+"_T"+str(T)+"_3d_isotropicdx20to50m_openend_qice0_600mdepth_frazil_nodragside_inflow/"
