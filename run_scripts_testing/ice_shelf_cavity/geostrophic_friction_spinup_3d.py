...
if not DUMP:
   # mesh = Mesh(f"./3d_crevasse_flume_dx250mto20m_dz5m_crevdxz5m_{args.angle}.msh", name=f"3dcrevasse_{args.angle}")
    mesh = BoxMesh(10, 10, 40, 5e3, 5e3, 100)#Mesh(f"./3d_crevasse_flume_dx250mto20m_dz2to5to10m_crevdxz5m_along.msh", name=f"3dcrevasse_{args.angle}")
...
vp_bcs = {5: {'un': no_normal_flow},
        6: {'un': no_normal_flow, 'drag': 2.5e-3}} # gmsh bcs
...
# Set up folder
folder = f"/data0/wis15/3d_crevasse/{args.date}_5kmflume_3_eq_param_nomelt_dt{dt}_dtOutput{output_dt}_T{T}_3d_openbox_bodyforce_posv_qice0_dx500m_dz10_qadv_balp_mu1e-3_advectionds_spinup_bodyforcemom_topfriction/"
