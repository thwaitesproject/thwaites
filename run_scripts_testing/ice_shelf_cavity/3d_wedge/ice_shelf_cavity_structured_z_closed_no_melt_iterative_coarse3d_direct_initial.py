...
mesh = BoxMesh(20,20,20,5000,5000,40)
...
sponge_fraction = 0.25  # fraction of domain where sponge
...
folder = "/data/3d_mitgcm_comparison/"+str(args.date)+"_3d_no_melt_dt"+str(dt)+\
         ...
         "_constantfrac0.25Tres"+str(restoring_time)+"_Kh"+str(kappa_h.values()[0])+"_Kv"+str(kappa_v.values()[0])\
         +"_dxy250_dz2_closed_iterative_box_no_drag_direct_initial_solve_sal_forcingdelPSU0.1/"
