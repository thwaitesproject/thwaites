...
output_folder = "/data/mitgcm_comparison_videos/layered_meshes/2d_50days_layered_01.06.20_3_eq_param_ufricHJ99_dt120.0_dtOutput3600.0_T4320000.0_ip50.0_tres86400.0_Kh0.001_openoceanKv0.001_dy50_nz10_closed_iterative/"
##########
...
def MITgcm_Thwaites_comparison_plot(t, fields, same_colour_scale=True):
    ...
    model = ["Constant dz = 1m, dt = 30s", "Layers = 10, dt = 120s"]
    ax = []
