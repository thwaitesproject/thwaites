...
# Set up folder
folder = "/data/2d_terrace/"+str(args.date)+"basalterrace_3_eq_param_ufricHJ99_dt"+str(dt)+\
         "_dtOutput"+str(output_dt)+"_T"+str(T)+"_isotropicdx5to25m_open_iterative_0.025inflow_qice=0_400mdepth_frazil_limfraz5e-9_sloped45deg/"
