...
# Define a dump file
dump_file = "/data/2d_mitgcm_comparison/17.04.20_3_eq_param_ufricHJ99_dt30.0_dtOutput3600.0_T4320000.0_ip50.0_tres86400.0_Kh0.001_Kv0.0001_dy50_dz1_closed_iterative/dump.h5"
...
# Initial turbluent kinetic energy and dissipation
tke0 = Constant(1e-7)
...
rans_fields = {'velocity': v_, 'viscosity': mu, 'diffusivity': kappa, 'density': rho_prime}
##########
...
# Set up RANS model
rans = RANSModel(rans_fields, mesh, bcs=vp_bcs, options={'l_max': 100.0})
rans._create_integrators(BackwardEuler, dt, vp_bcs, rans_solver_parameters)
rans.initialize(rans_tke=tke0, rans_psi=psi0)

vp_fields['rans_eddy_viscosity'] = rans.eddy_viscosity
...
# Set up folder
folder = "/data/2d_rans_ice_shelf_cavity/"+str(args.date)+"_3_eq_param_ufricHJ99_dt"+str(dt)+\
         ...
         +"_dy50_dz1_closed_iterative_rans/"
