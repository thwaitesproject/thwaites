...
def mesh_annulus_gmshapi(name="annulus", iR=0.5, oR=3.0, nR=21, nT=16, x0=0.0, y0=0.0,
                         do_quads=False, progression=1.0, order=1, msh_file=None, comm=MPI.COMM_WORLD, meshType="Progression"):
    """
    ...
    if comm.rank == 0:
        ...
        ring_inner = 1  # add minus sign.... to get positive id below...?
        ...
        gmsh.model.mesh.setTransfiniteCurve(l0, numNodes=nR, meshType=meshType, coef=progression)
...
mesh_annulus_gmshapi(iR=2.5, oR=8,nR=10, nT=20, msh_file="annulus_surface_nR10_nT20.msh")
