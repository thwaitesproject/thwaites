...
PETSc.Sys.Print("Length of bottom", assemble(Constant(1.0)*ds("bottom", domain=mesh)))

PETSc.Sys.Print("Length of top", assemble(Constant(1.0)*ds("top", domain=mesh)))
...
vp_bcs = {"top": {'un': no_normal_flow, 'drag': ice_drag}, 2: {'un': no_normal_flow},
          "bottom": {'un': no_normal_flow, 'drag': 0.0025}, 1: {'un': no_normal_flow}}
