...
km = 1000;
Point(1) = {0, 0, -500, 25};
Point(2) = {0, 5*km, -500, 25};
Point(3) = {5*km, 5*km, -500, 25};
Point(4) = {5*km, 0, -500, 25};

// top surface bottom of crevasse
Point(5) = {1*km, 2.4*km, -500, 5};
Point(6) = {1*km, 2.6*km, -500, 5};
Point(7) = {4*km, 2.6*km, -500, 5};
Point(8) = {4*km, 2.4*km, -500, 5};

// top surface top of crevasse
Point(9) = {1.1*km, 2.475*km, -450, 5};
Point(10) = {1.1*km, 2.525*km, -450, 5};
Point(11) = {3.9*km, 2.525*km, -450, 5};
Point(12) = {3.9*km, 2.475*km, -450, 5};

// Bottom corners
Point(13) = {0, 0, -600, 25};
Point(14) = {0, 5*km, -600, 25};
Point(15) = {5*km, 5*km, -600, 25};
Point(16) = {5*km, 0, -600, 25};
