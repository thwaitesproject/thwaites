...
mesh = SquareMesh(40,800,100, quadrilateral=True)
...
temp_bcs = {4: {'flux': -mp.T_flux_bc}, 2:{'qadv': T_restore}}
...
sal_bcs = {4: {'flux':  -mp.S_flux_bc}, 2:{'qadv': S_restore}}
...
folder = "/data/balance_pressure/"+str(args.date)+"_thwaites_dt"+str(dt)+\
         "_dtOutput"+str(output_dt)+"_T"+str(T)+"_isodx2.5m_iter_600m_box_TSref_nocor_noinitp_nobcsgradbp_melt_nolim_isokapnu_pb_quad_squash_dz0.125/"
