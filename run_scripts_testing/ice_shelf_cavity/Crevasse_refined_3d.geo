...
// nearside y = 0 plane
Point(1) = {0, 0, -400, 25.0};
Point(2) = {0, 0, -300, 25.0};

Point(3) = {2330, 0, -300, 10.0};


Point(4) = {2330, 0, -40, 10.0};

Point(5) = {2670, 0, -40, 10.0};
Point(6) = {2670, 0, -300, 10.0};

Point(7) = {5000, 0, -300, 25.0};
Point(8) = {5000, 0, -400, 25.0};

// farside y = 50 plane
Point(9) = {0, 50, -400, 25.0};
Point(10) = {0, 50, -300, 25.0};

Point(11) = {2330, 50, -300, 10.0};

Point(12) = {2330, 50, -40, 10.0};

Point(13) = {2670, 50, -40, 10.0};
Point(14) = {2670, 50, -300, 10.0};

Point(15) = {5000, 50, -300, 25.0};
Point(16) = {5000, 50, -400, 25.0};
