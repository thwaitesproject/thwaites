...
# create mesh
mesh = Mesh("./thwaites_gz_crevasse_3d.msh")
...
temp_bcs = {4: {'flux': -mp.T_flux_bc}, 3:{'q': T_restore}, 2:{'q': T_restore}, 5:{'q': T_restore}, 6:{'q': T_restore}}

sal_bcs = {4: {'flux': -mp.S_flux_bc}, 3:{'q': S_restore}, 2:{'q': S_restore}, 5:{'q': S_restore}, 6:{'q': S_restore}}
...
folder = "/data/3d_crevasse/"+str(args.date)+"_3_eq_param_ufricHJ99_dt"+str(dt)+\
         "_dtOutput"+str(output_dt)+"_T"+str(T)+"_3d_isotropicdx10to25m_open_qice0_600mdepth_frazil_sharpmesh_2000m_wide_iterative_nodragside_stresslhs0.9x/"
